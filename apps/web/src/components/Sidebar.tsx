    ...
    return (
      <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-brand/[8%] border border-brand/15 animate-in fade-in slide-in-from-left-2">
        <input
          ...
          className="flex-1 bg-transparent border-b border-brand/40 text-foreground text-[13px] focus:outline-none px-1 py-0.5"
          autoFocus
        />

        <button
          onClick={onRename}
          className="p-1.5 text-brand hover:bg-brand/10 rounded-lg touch-manipulation"
        ...
        <button
          ...
          className="p-1.5 text-foreground/30 hover:text-foreground rounded-lg touch-manipulation"
...
export function Sidebar() {
  ...
  const handleDeleteConversation = async (id: string) => {
    try {
      ...
      console.error(
        '[Sidebar] Failed to delete conversation:',
        error
      );
    }
  ...
  const handleRename = async (id: string) => {
    ...
    if (title) {
      try {
        ...
        console.error(
          '[Sidebar] Failed to rename conversation:',
          error
        );
      }
    }
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 h-16 shrink-0 border-b border-border">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="p-2 rounded-lg text-foreground/30 hover:text-brand hover:bg-brand/[8%] transition-all lg:hidden touch-manipulation"
        ...
        <div className="p-4 border-t border-border bg-gradient-to-b from-transparent to-surface/80 shrink-0">
          ...
          <div className="mb-4 p-3.5 rounded-xl border border-brand/[10%] bg-gradient-to-br from-brand/[5%] to-transparent relative overflow-hidden group cursor-pointer">
            ...
            <div className="flex items-start gap-3 mb-3 relative z-10">
              ...
              <div>
                ...
                <p className="text-[11px] text-foreground/30 mt-0.5 leading-relaxed">
          ...
          {user && (
            ...
            >
              ...
              <div className="flex items-center gap-0.5 opacity-0 group-hover/profile:opacity-100 transition-all duration-200 lg:flex hidden">
                <button
                  onClick={(event) => {
                    event.stopPropagation();
                  ...
                  className="p-2 rounded-lg hover:bg-surface-2 transition-colors text-foreground/30 hover:text-foreground"
                  title="Paramètres"
                ...
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-red-500/10 transition-colors text-foreground/30 hover:text-red-400"
                  title="Déconnexion"
...
function ThemeSwitcherRow() {
  ...
  return (
    <div className="mb-3">
      <div className="text-[10px] font-bold uppercase tracking-[0.15em] px-1 mb-2 text-foreground/20 select-none">
        Thème
      </div>
